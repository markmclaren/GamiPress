...
<p>GamiPress supports multiple <strong>points types</strong> (Credits, Gems, Coins). Your balances below are rendered dynamically by <code>gamipress_points</code> shortcode:</p>
[gamipress_points]
